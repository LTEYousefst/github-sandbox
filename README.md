...
A GitHub tions workflow that lets you download files into your repository just by writing a special commit message — no terminal or command line needed.
...
0. Fork this repo
1. Go to your reposi on GitHub 
2. Click **Settings** → **Actions** → **General**
3. Scroll down to **Workflow permissions**
4. Select **Read d write permissions** and click **Save**
